...
local def_order = {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit Miss Ratio", "Backtrack", "Body yaw", "Flags"}
local order = {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit Miss Ratio", "Backtrack", "Body yaw", "Flags"}
...
menu = {
    ...
    options = ui.new_multiselect("RAGE", "Other", "H: Options", {"Id", "Player", "Hitbox", "Hit", "Hit count", "Miss count", "Hit miss ratio", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
	...
	reset_stats = ui.new_button("RAGE", "Other", "H: Reset stats", clear_stats),
    all_flags = ui.new_checkbox("RAGE", "Other", "H: Draw all flags"),
    ordering = ui.new_checkbox("RAGE", "Other", "H: Ordering"),
    ordering_element = ui.new_combobox("RAGE", "Other", "H: Ordering element", {"Id", "Player", "Hitbox", "Hit", "Hit count", "Miss count", "Hit miss ratio", "Hit chance", "Damage", "Backtrack", "Body yaw", "Flags"}),
    to_left = ui.new_button("RAGE", "Other", "H: To the left", ordering_toleft),
    to_right = ui.new_button("RAGE", "Other", "H: To the right", ordering_toright),
    reset_ord = ui.new_button("RAGE", "Other", "H: Reset default order", reset_default_ord),

    -- invisible combos to make it save to the config.
    ord_checkbox = ui.new_checkbox("Rage", "Other", "H: Defaults"),
    ord = {
        ui.new_combobox("RAGE", "Other", "H: Order 1", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 2", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 3", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 4", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 5", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 6", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 7", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
        ui.new_combobox("RAGE", "Other", "H: Order 8", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
		ui.new_combobox("RAGE", "Other", "H: Order 9", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
		ui.new_combobox("RAGE", "Other", "H: Order 10", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
		ui.new_combobox("RAGE", "Other", "H: Order 11", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
		ui.new_combobox("RAGE", "Other", "H: Order 12", {"Id", "Player", "Hitbox", "Hit", "Hit chance", "Damage", "Hit count", "Miss count", "Hit miss ratio", "Backtrack", "Body yaw", "Flags"}),
    }
}
...
local draw = {
	...
	hit = {
        ...
        header = "HIT",
        draw = function(c, pitch, yaw, data, sum, alpha_modifier)
            draw_text(c, pitch + sum, yaw + 1, 255, 255, 255, 255*alpha_modifier, nil, 70, data.hit)
        end
    },
	hit_count = {
        enable = false,
        ...
        header = "HITS",
        draw = function(c, pitch, yaw, data, sum, alpha_modifier)
            draw_text(c, pitch + sum, yaw + 1, 255, 255, 255, 255*alpha_modifier, nil, 70, data.hit_count)
        end
    },
	miss_count = {
        enable = false,
        ...
        header = "MISSES",
        draw = function(c, pitch, yaw, data, sum, alpha_modifier)
            draw_text(c, pitch + sum, yaw + 1, 255, 255, 255, 255*alpha_modifier, nil, 70, data.miss_count)
        end
    },
	hit_miss_count = {
        enable = false,
        ...
        header = "HIT  RATIO",
        draw = function(c, pitch, yaw, data, sum, alpha_modifier)
            draw_text(c, pitch + sum, yaw + 1, 255, 255, 255, 255*alpha_modifier, nil, 70, data.hit_miss_count)
        end
    },
    hit_chance = {
        enable = false,
...
local function get_ordered_element(i)
    ...
    elseif order[i] == "Hitbox" then
        return draw.hitbox
	elseif order[i] == "Hit" then
		return draw.hit
	elseif order[i] == "Hit chance" then
        return draw.hit_chance
    elseif order[i] == "Damage" then
        return draw.damage
	elseif order[i] == "Hit count" then
		return draw.hit_count
	elseif order[i] == "Miss count" then
		return draw.miss_count
	elseif order[i] == "Hit miss ratio" then
		return draw.hit_miss_count
...
ui.set_callback(menu.options, function()
	...
	if contains(options, "Hit") then draw.hit.enable = true else draw.hit.enable = false end
	if contains(options, "Hit count") then draw.hit_count.enable = true else draw.hit_count.enable = false end
	if contains(options, "Miss count") then draw.miss_count.enable = true else draw.miss_count.enable = false end
	if contains(options, "Hit miss ratio") then draw.hit_miss_count.enable = true else draw.hit_miss_count.enable = false end
...
client.set_event_callback("aim_fire", function(e)
    if ui_get(menu.enabled) then
		...
		hmratio = (hitcounter/(hitcounter + misscounter))
		hmratio = math.floor(hmratio * 100)/100
		...
		table_fire = {
			...
			["miss_count"] = misscounter,
			["hit_miss_count"] = hmratio,
...
local function visibility()
	...
	ui.set_visible(menu.reset_stats, rpc)
